...
const chunknode = preload("res://src/scenes/level/testMapChunk.tscn")
#const chunknode = preload("res://src/scenes/chunkNode.tscn")
var  chunk_scene_relation = {
	Vector2(0,0):{
		"chunk_name": "SPAWN",
		"chunk_node": preload("res://src/scenes/level/testMapChunk.tscn")
	},
	Vector2(0,-1):{
		"chunk_name": "Boss fight",
		"chunk_node": preload("res://src/scenes/level/testMapChunk.tscn")
	},
	Vector2(1,0):{
		"name": "",
...
#func lê o dicionario de mapas e retorna o mapa correto
func _find_correct_map(pos):
	pass
...
#				var chunk
#				if chunk_scene_relation.has(chunk_coords):
#					chunk = chunk_scene_relation[chunk_coords]["chunk_node"]
#				else: 
#					chunk = chunknode.instance()
